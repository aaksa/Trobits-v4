...
class WelcomePopUpWidget extends StatefulWidget {
  const WelcomePopUpWidget({super.key});

  @override
  State<WelcomePopUpWidget> createState() => _WelcomePopUpWidgetState();
}

class _WelcomePopUpWidgetState extends State<WelcomePopUpWidget> {
  late WelcomePopUpModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WelcomePopUpModel());
            ...
            children: [
              ...
              Padding(
                ...
                child: InkWell(
                  ...
                  onTap: () async {
                    logFirebaseEvent(
                        'WELCOME_POP_UP_COMP_replaceWidget_ON_TAP');
              ...
              Builder(
                builder: (context) => InkWell(
                  ...
                  highlightColor: Colors.transparent,
                  onTap: () async {
                    logFirebaseEvent('WELCOME_POP_UP_COMP_wrapWidget_ON_TAP');
