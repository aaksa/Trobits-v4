...
class _NewsWidgetState extends State<NewsWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<ApiCallResponse>(
      future: FFAppState().newcache(
        requestFn: () => NewsLatestCall.call(),
      ),
      builder: (context, snapshot) {
        ...
        final newsNewsLatestResponse = snapshot.data!;
                                                      ...
                                                      builder: (context) {
                                                        final eachNewsData =
                                                            ((getJsonField(
                                                                      ...
                                                                      r'''$.data''',
                                                                      true,
                                                                    )?.toList().map<CryptonewsStruct?>(CryptonewsStruct.maybeFromMap).toList()
