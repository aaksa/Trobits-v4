...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'Leaderboard',
          path: '/leaderboard/:coinCategory',
          builder: (context, params) => LeaderboardWidget(
            coinCategory: params.getParam(
              'coinCategory',
              ParamType.String,
            ),
          ),
        ...
        FFRoute(
          name: 'HowItWorks',
          path: '/howitworks',
          builder: (context, params) => const HowItWorksWidget(),
        ),
        FFRoute(
          name: 'Aboutus',
          path: '/aboutus',
        ...
        FFRoute(
          name: 'Disclaimer',
          path: '/disclaimer',
          builder: (context, params) => const DisclaimerWidget(),
        ),
        FFRoute(
          name: 'Article',
          path: '/article',
        ...
        FFRoute(
          ...
          path: '/articledetail',
          asyncParams: {
            'article': getDoc(['Article'], ArticleRecord.fromSnapshot),
          },
